...
class CodeRegisterFileLogController extends Controller
{
    public function __construct()
    {
        $this->title = 'Code Register File Logs';
        $this->view = 'panel.admin.code-register-file-log';
        $this->route = 'panel.admin.code-register-file-logs';
    }
    ...
    {
        $data['agentRecord'] = CodeRegisterFile::find($request->code_register_file_id);
        ...
        $rows = CodeRegisterFileLog::query();
        ...
        if ($request->get('code_register_file_id')) {
            $rows->where('code_register_file_id', $request->get('code_register_file_id'));
        }
    ...
    public function create(Request $request)
    {
        try {
            $data['agentRecord'] = CodeRegisterFile::find($request->code_register_file_id);
            $title = isset($data['agentRecord']) ? $data['agentRecord']->id : '';
            $data['title'] = $title.' '.$this->title;
            $data['view'] = $this->view;
            $data['route'] = $this->route;
    ...
    public function store(Request $request)
    {
        ...
        try {
            $codeRegisterFile = CodeRegisterFileLog::create($request->all());
    ...
    public function edit(Request $request, $id)
    {
        try {
            ...
            $data['item'] =CodeRegisterFileLog::whereId($id)->firstOrFail();
            $data['agents'] = Agent::select('id', 'name')->get();
    ...
    {
        $codeRegisterFile = CodeRegisterFileLog::find($id);
    ...
    public function destroy($id)
    {
        try {
            ...
            $codeRegisterFile =CodeRegisterFileLog::whereId($id)->firstOrFail();
            if ($codeRegisterFile) {
    ...
    public function bulkAction(Request $request)
    {
        ...
        try {
            ...
            switch ($request->action) {
                // Delete
                case ('delete'):
                    CodeRegisterFileLog::whereIn('id', $request->ids)->delete();
                    $msg = 'Bulk delete!';
