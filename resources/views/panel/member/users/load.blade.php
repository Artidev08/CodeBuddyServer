<div class="table-controller mb-2">
    <div class="d-flex justify-content-between">
        @if (getSetting('user_management_table_record_limit', @$setting))
            <div class="mr-3">
        ...
        @endif
        @if (getSetting('user_management_table_excel_export', @$setting))
            <div>
    ...
    <div class="d-flex justify-content-between">
        <div>
            @if (getSetting('user_management_table_search', @$setting))
