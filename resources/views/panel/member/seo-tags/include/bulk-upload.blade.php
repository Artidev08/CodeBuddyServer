    ...
    <div class="modal-dialog modal-dialog-centered modal-center">
        <div class="modal-content" style="width: 170%;">
            <div class="modal-header">
                ...
                <form action="{{ route('panel.admin.seo-tags.export') }}" method="POST" enctype="multipart/form-data"
                    onsubmit="return checkCoords();">
                    @csrf
                    <div class="d-flex justify-content-between mt-0">
                        <div class="text-right">
                            <button type="submit"
                                href="{{ route('panel.admin.seo-tags.export') }}"class="btn btn-link">Download
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="previous-month" role="tabpanel"
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('panel.admin.bulk.seo') }}" method="POST" enctype="multipart/form-data"
                            onsubmit="return checkCoords();">
                            @csrf
                            <div>
                                ...
                                <div class="alert alert-info" style="padding: 0.75rem 1rem;">
                                    <p class="mb-0">Code field is required.</p>
                                    <p class="mb-0">Title field is required.</p>
                                    <p class="mb-0">Keyword field is required.</p>
                            ...
                            <small class="text-danger text-left fw-700">Allowed file: .xlsx</small>
                    </div>
