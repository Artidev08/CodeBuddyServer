<div class="card-body">
        ...
        <div class="d-flex justify-content-between">
                ...
                <label for="">Show
                    <select name="length" class="length-input" id="length">
                        @foreach (tableLimits() as $limit)
                            <option
                                value="{{ $limit }}"{{ $languages->perPage() == @$limit ? 'selected' : '' }}>
                                {{ $limit }}</option>
                        @endforeach
                    </select>
                    entries
            ...
            <div class="d-flex">
                ...
                {{--
                    ...
                    data-url="{{ route('admin.languages.print') }}"
                    data-rows="{{json_encode($languages) }}"
    ...
    <div class="table-responsive">
        @include('panel.member.languages.table')
    </div>
</div>
