...
@section('title', 'Relation' . ' Show')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Relation', 'url' => route('panel.admin.relations.index'), 'class' => ''],
            ['name' => 'Show ' . $relation->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-6 text-muted">
                            ...
                            <h6 class="text-black">{{ $relation->name }}</h6>
                        ...
                        <div class="col-md-4 col-6 text-muted">
                            ...
                            <h6 class="text-black">{{ $relation->description }}</h6>
