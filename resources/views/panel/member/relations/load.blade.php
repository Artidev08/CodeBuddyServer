<div class="card-body">
    <div class="table-controller mb-2">
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex">
                    ...
                    data-url="{{ route('admin.relations.print') }}"
                    data-rows="{{json_encode($relations) }}"
    ...
    <div class="table-responsive">
        @include('panel.member.relations.table')
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="pagination mobile-justify-center">
                {{ $relations->appends(request()->except('page'))->links() }}
            </div>
        </div>
