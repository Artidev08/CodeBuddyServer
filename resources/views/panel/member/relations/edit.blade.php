...
@section('title', 'Relation' . ' Edit')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Relation', 'url' => route('panel.admin.relations.index'), 'class' => ''],
            ['name' => 'Edit ' . $relation->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>@lang('admin/ui.edit') Relation </h5>
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>@lang('admin/ui.update') Relation</h3>
                    </div>
                    <div class="card-body">
                        <form class="ajaxForm" action="{{ route('panel.admin.relations.update', $relation->id) }}"
                            method="post" enctype="multipart/form-data" id="RelationForm">
                            @csrf
                            ...
                            <x-input type="hidden" validation="" value="{{ $relation->id }}" name="id" id="id"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        ...
                                        <x-input type="text" validation="common_name" value="{{ $relation->name }}"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                        <x-label name="description" validation="" tooltip="add_description"
                                            class="" />
                                        <x-input type="text" validation="" value="{{ $relation->description }}"
                                ...
                                @endphp
                                    <div class="form-group {{ @$errors->has('is_ai_enabled') ? 'has-error' : '' }}">
                                        <x-checkbox name="is_ai_enabled" class="js-switch switch-input" value="{{ $relation->is_ai_enabled }}"
                                ...
                                <div class="col-md-12 mx-auto">
                                    <div class="form-group">
                                        <span class="updated-at-floating-btn" title="@lang('admin/ui.last_updated_at')"><i
                                                class="ik ik-clock mr-1"></i>{{ $relation->updated_at->diffForHumans() }}</span>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit"
