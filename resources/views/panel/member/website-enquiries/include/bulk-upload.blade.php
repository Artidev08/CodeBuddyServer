    ...
    <div class="modal-dialog modal-dialog-centered modal-center">
        <div class="modal-content" style="width: 170%;">
            <div class="modal-header">
                ...
                <form action="{{ route('panel.admin.website-enquiries.export') }}" method="POST"
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="previous-month" role="tabpanel"
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('panel.admin.bulk.website-enquiries') }}" method="POST"
                            enctype="multipart/form-data" onsubmit="return checkCoords();">
                            @csrf
                            <div>
                                ...
                                <div class="alert alert-info" style="padding: 0.75rem 1rem;">
                                    <p class="mb-0">Name field is required.</p>
                                    <p class="mb-0">Email field is required.</p>
                                    <p class="mb-0">Contact field is required.</p>
                                    <p class="mb-0">Subject field is required.</p>
                                    <p class="mb-0">Description field is required.</p>
                                </div>
                            </div>
                            ...
                            <small class="text-danger text-left">Allowed file: ..xlsx ..xlsx</small>
                    </div>
