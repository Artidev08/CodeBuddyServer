<div class="card-body">
        ...
        <div class="d-flex justify-content-between">
                ...
                <label for="">Show
                    <select name="length" class="length-input" id="length">
                        @foreach (tableLimits() as $limit)
                            <option value="{{ $limit }}"{{ $contents->perPage() == @$limit ? 'selected' : '' }}>
                                {{ $limit }}</option>
                        @endforeach
                    </select>
                    entries
            ...
            <div class="d-flex">
                ...
                {{--
                    ...
                    data-url="{{ route('admin.contents.print') }}"
                    data-rows="{{json_encode($contents) }}"
    ...
    <div class="table-responsive">
        @include('panel.member.contents.table')
    </div>
</div>
