...
@section('title', 'Gender Specificity' . ' Edit')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Gender Specificity', 'url' => route('panel.member.gender-specificities.index'), 'class' => ''],
            ['name' => 'Edit ' . $genderSpecificity->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>@lang('admin/ui.edit') Gender Specificity </h5>
                            <span>@lang('admin/ui.update_a_record_for')
                                Gender Specificity</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>@lang('admin/ui.update') Gender Specificity</h3>
                    </div>
                    <div class="card-body">
                        <form class="ajaxForm"
                            action="{{ route('panel.member.gender-specificities.update', $genderSpecificity->id) }}"
                            method="post" enctype="multipart/form-data" id="GenderSpecificityForm">
                            @csrf
                            ...
                            <x-input type="hidden" validation="" value="{{ $genderSpecificity->id }}" name="id"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        <x-label name="name" validation="common_name"  tooltip="add_gender_specificity_name" class="" />
                                        <x-input type="text" validation="common_name"  value="{{ $genderSpecificity->name }}"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('emoji') ? 'has-error' : '' }}">
                                        <x-label name="emoji" validation="" tooltip="add_gender_specificity_emoji" class="" />
                                        <x-input type="text" validation="" value="{{ $genderSpecificity->emoji }}"
                                            name="emoji" id="emoji" placeholder="Enter Emoji" class="form-control"
                                            tooltip="add_gender_specificity_emoji" />
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                        <x-label name="description" validation="" tooltip="add_gender_specificity_description" class="" />
                                        <textarea name="description" id="description" placeholder="Enter Description" 
                                                  class="form-control" tooltip="add_gender_specificity_description">
                                            {{ old('description',  $genderSpecificity->description) }}
                                        </textarea>
                                    </div>
                                </div>
                                @php
                            ...
                            @endphp
                             <div class="col-md-6 mt-35">
                                <div class="form-group {{ @$errors->has('is_ai_enabled') ? 'has-error' : '' }}">
                                    <x-checkbox name="is_ai_enabled" class="js-switch switch-input" value="{{$genderSpecificity->is_ai_enabled}}"
