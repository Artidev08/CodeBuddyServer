...
@section('title', 'Media Type' . ' Edit')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Media Type', 'url' => route('panel.member.media-types.index'), 'class' => ''],
            ['name' => 'Edit ' . $mediaType->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>@lang('admin/ui.edit') Media Type </h5>
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>@lang('admin/ui.update') Media Type</h3>
                    </div>
                    <div class="card-body">
                        <form class="ajaxForm" action="{{ route('panel.member.media-types.update', $mediaType->id) }}"
                            method="post" enctype="multipart/form-data" id="MediaTypeForm">
                            @csrf
                            ...
                            <x-input type="hidden" validation="" value="{{ $mediaType->id }}" name="id"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        ...
                                        <x-input type="text" validation="add_media_type_name" value="{{ $mediaType->name }}"
                                ...
                                <div class="col-md-12 mx-auto">
                                    <div class="form-group">
                                        <span class="updated-at-floating-btn" title="@lang('admin/ui.last_updated_at')"><i
                                                class="ik ik-clock mr-1"></i>{{ $mediaType->updated_at->diffForHumans() }}</span>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit"
