...
@section('title', 'Media Type' . ' Show')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Media Type', 'url' => route('panel.member.media-types.index'), 'class' => ''],
            ['name' => 'Show ' . $mediaType->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-6 text-muted">
                            ...
                            <h6 class="text-black">{{ $mediaType->name }}</h6>
