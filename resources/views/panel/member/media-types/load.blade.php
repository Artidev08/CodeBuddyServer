<div class="card-body">
    <div class="table-controller mb-2">
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex">
                    ...
                    data-url="{{ route('admin.media-types.print') }}"
                    data-rows="{{json_encode($mediaTypes) }}"
    ...
    <div class="table-responsive">
        @include('panel.member.media-types.table')
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="pagination mobile-justify-center">
                {{ $mediaTypes->appends(request()->except('page'))->links() }}
            </div>
        </div>
        <div class="col-lg-4 mobile-mt-20">
            @if($mediaTypes->lastPage() > 1)
