<div class="card-body">
    <div class="table-controller mb-2">
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex">
                    ...
                    data-url="{{ route('admin.age-groups.print') }}"
                    data-rows="{{json_encode($ageGroups) }}"
    ...
    <div class="table-responsive">
        @include('panel.member.age-groups.table')
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="pagination mobile-justify-center">
                {{ $ageGroups->appends(request()->except('page'))->links() }}
            </div>
        </div>
        <div class="col-lg-4 mobile-mt-20">
            @if($ageGroups->lastPage() > 1)
