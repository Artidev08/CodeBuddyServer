...
@section('content')
    @php
        ...
        $breadcrumb_arr = [
            ...
            ['name' => 'Add Content Length', 'url' => 'javascript:void(0);', 'class' => 'active'],
        ];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>@lang('admin/ui.add') Content Length</h5>
                            <span>@lang('admin/ui.add_a_new_record_for') Content Length</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>@lang('admin/ui.create') Content Length</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('panel.member.content-lengths.store') }}" method="post"
                            enctype="multipart/form-data" class="ajaxForm" id="ContentLengthForm">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        <x-label name="name" validation="" tooltip="add_name" class="" />
                                        <select name="name" id="" class="form-control">
                                            @foreach(getContentLength() as $key => $length)
                                                <option value="{{ $length['name'] }}">{{ $length['name'] }}( {{$length['length']}} Chars) </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            @endphp
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                        <x-label name="description" validation="" tooltip="add_description"
                                            class="" />
                                        <textarea name="description" id="description" placeholder="Enter Description" class="form-control" rows="4"
                                            tooltip="add_description">{{ old('description') }}</textarea>
                                    </div>
