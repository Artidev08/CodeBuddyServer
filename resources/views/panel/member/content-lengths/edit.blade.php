...
@section('title', 'Content Length' . ' Edit')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Content Length', 'url' => route('panel.member.content-lengths.index'), 'class' => ''],
            ['name' => 'Edit ' . $contentLength->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>@lang('admin/ui.edit') Content Length </h5>
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>@lang('admin/ui.update') Content Length</h3>
                    </div>
                    <div class="card-body">
                        <form class="ajaxForm"
                            action="{{ route('panel.member.content-lengths.update', $contentLength->id) }}" method="post"
                            enctype="multipart/form-data" id="ContentLengthForm">
                            @csrf
                            ...
                            <x-input type="hidden" validation="" value="{{ $contentLength->id }}" name="id"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        <x-label name="name" validation="common_name" tooltip="contentlenght_name" class="" />
                                        <x-input type="text" validation="" value="{{ $contentLength->name }}"
                            ...
                            @endphp
                                <div class="col-md-6 mt-35">
                                    <div class="form-group {{ @$errors->has('is_ai_enabled') ? 'has-error' : '' }}">
                                        <x-checkbox name="is_ai_enabled" class="js-switch switch-input" value="{{ $contentLength->is_ai_enabled }}"
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <x-label name="description" validation="" tooltip="contentlenght_description" class="" />
        
                                        <textarea name="description" id="description" class="form-control" > {{ old('description', $contentLength->description) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mx-auto">
                                    <div class="form-group">
    ...
    @push('script')
        <script>
            $('.ajaxForm').on('submit', function(e) {
                ...
                let redirectUrl = "{{ url('admin/content-lengths') }}";
