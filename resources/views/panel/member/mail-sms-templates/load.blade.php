    ...
    <div class="table-responsive">
        <table id="mailSmsTable" class="table">
            ...
            <tbody class="">
                        ...
                        <div class="dropdown d-flex">
                            ...
                            <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                <li class="dropdown-item p-0"><a
                                        href="{{ route('panel.member.templates.show', secureToken($mailSmsTemplate->id)) }}"
                                ...
                                <li class="dropdown-item p-0"><a
                                        href="{{ route('panel.member.templates.edit', secureToken($mailSmsTemplate->id)) }}"
                                ...
                                <li class="dropdown-item p-0"><a
                                        href="{{ route('panel.member.templates.destroy', secureToken($mailSmsTemplate->id)) }}"
                ...
                @else
                <tr>
                    <td class="text-center" colspan="8">@include('panel.member.include.components.no-data-img')</td>
                </tr>
                @endif
            </tbody>
        </table>
