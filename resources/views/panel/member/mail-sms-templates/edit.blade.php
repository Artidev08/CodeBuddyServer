...
@section('content')
    @php
        $breadcrumb_arr = [
            [
                ...
                'url' => route('panel.member.templates.index'),
                'class' => '',
            ],
            ['name' => $mailSmsTemplate->getPrefix(), 'url' => route('panel.member.templates.index'), 'class' => ''],
            ['name' => __('admin/ui.edit'), 'url' => route('panel.member.templates.index'), 'class' => 'active'],
        ];
    @endphp
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('panel.member.templates.update', $mailSmsTemplate->id) }}" method="post" class="ajaxForm">
            @csrf
            <div class="row">
                <!-- start message area-->
