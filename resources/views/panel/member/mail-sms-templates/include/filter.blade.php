<div class="side-slide" style="right: -100%;">
    <div class="filter">
        <div class="card-header d-flex justify-content-between">
            <h5 class="text-dark mt-2"> @lang('admin/ui.filter') </h5>
            <button type="button" class="close off-canvas text-dark" data-type="close">
            ...
            <form action="" class="d-flex" method="GET" id="TableForm">
                <div class="row">
                    ...
                    <div class="col-12 mt-2 ">
                        <button type="submit" class="btn btn-primary">@lang('admin/ui.apply')   @lang('admin/ui.filter') </button>
