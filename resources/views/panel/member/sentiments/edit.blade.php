...
@section('title', 'Sentiment' . ' Edit')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Sentiment', 'url' => route('panel.member.sentiments.index'), 'class' => ''],
            ['name' => 'Edit ' . $sentiment->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>@lang('admin/ui.edit') Sentiment </h5>
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>@lang('admin/ui.update') Sentiment</h3>
                    </div>
                    <div class="card-body">
                        <form class="ajaxForm" action="{{ route('panel.member.sentiments.update', $sentiment->id) }}"
                            method="post" enctype="multipart/form-data" id="SentimentForm">
                            @csrf
                            ...
                            <x-input type="hidden" validation="" value="{{ $sentiment->id }}" name="id"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        <x-label name="name" validation="common_name" tooltip="add_sentiment_name"
                                            class="" />
                                        <x-input type="text" validation="common_name" value="{{ $sentiment->name }}"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('emoji') ? 'has-error' : '' }}">
                                        ...
                                        <x-input type="text" validation="" value="{{ $sentiment->emoji }}"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('sequence') ? 'has-error' : '' }}">
                                        ...
                                        <x-input type="text" validation="" value="{{ $sentiment->sequence }}"
                                            name="sequence" id="sequence" placeholder="Enter Sequence" class="form-control"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                        <x-label name="description" validation="" tooltip="add_sentiment_description"
                                            class="" />
                                        <textarea type="text" validation="" value="{{ $sentiment->description }}" name="description" id="description"
                                            placeholder="Enter Description" class="form-control" tooltip="add_sentiment_description">{{ old('description', $sentiment->description) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 p-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('is_published') ? 'has-error' : '' }}">
                                                <x-checkbox name="is_published" class="js-switch switch-input"
                                                    value="{{ $sentiment->is_published }}" type="checkbox" tooltip=""
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ @$errors->has('is_ai_enabled') ? 'has-error' : '' }}">
                                            <x-checkbox name="is_ai_enabled" class="js-switch switch-input" value="{{ $sentiment->is_ai_enabled }}"
                                ...
                                <div class="col-md-12 mx-auto">
                                    <div class="form-group">
                                        <span class="updated-at-floating-btn" title="@lang('admin/ui.last_updated_at')"><i
                                                class="ik ik-clock mr-1"></i>{{ $sentiment->updated_at->diffForHumans() }}</span>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit"
