...
@section('content')
    @php
        ...
        $breadcrumb_arr = [
            ['name' =>$occasionBreadcrumb. ' Event', 'url' => route('panel.member.events.index'), 'class' => ''],
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('panel.member.events.store') }}" method="post" enctype="multipart/form-data"
