    ...
    <div class="modal-dialog modal-dialog-centered modal-center">
        <div class="modal-content" style="width: 170%;">
            <div class="modal-header">
                ...
                <form action="{{ route('panel.admin.faqs.export') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="previous-month" role="tabpanel"
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('panel.admin.bulk.faqs') }}" method="POST" enctype="multipart/form-data"
                            onsubmit="return checkCoords();">
                            @csrf
                            <div>
                                ...
                                <div class="alert alert-info" style="padding: 0.75rem 1rem;">
                                    <p class="mb-0">Question field is required.</p>
                                    <p class="mb-0">Category field is required.</p>
