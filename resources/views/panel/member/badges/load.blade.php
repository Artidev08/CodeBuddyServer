<div class="card-body">
    <div class="table-controller mb-2">
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex">
                    ...
                    data-url="{{ route('admin.badges.print') }}"
                    data-rows="{{json_encode($badges) }}"
    ...
    <div class="table-responsive">
        @include('panel.member.badges.table')
    </div>
</div>
