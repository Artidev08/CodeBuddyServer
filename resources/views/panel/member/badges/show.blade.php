...
@section('title', 'Badge' . ' Show')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Badge', 'url' => route('panel.member.badges.index'), 'class' => ''],
            ['name' => 'Show ' . $badge->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-6 text-muted">
                            ...
                            <h6 class="text-black">{{ $badge->name }}</h6>
                        ...
                        <div class="col-md-4 col-6 text-muted">
                            ...
                            <h6 class="text-black">{{ $badge->description }}</h6>
