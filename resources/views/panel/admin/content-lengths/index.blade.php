                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_content_length'))
                                <a href="{{ route('panel.admin.content-lengths.create') }}"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.content-lengths.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.content-lengths.includes.filter')
    <!-- push external js -->
    @push('script')
        @include('panel.admin.include.more-action', [
            'actionUrl' => 'admin/content-lengths',
            'routeClass' => 'content-lengths',
        ])
        <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        <script>
            $('#reset').click(function() {
                let url = "{{ route('panel.admin.content-lengths.index') }}";
                fetchData(url);
