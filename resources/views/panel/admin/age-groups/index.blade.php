                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_age_group'))
                                <a href="{{ route('panel.admin.age-groups.create') }}" class="btn btn-sm btn-outline-primary mr-2"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.age-groups.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.age-groups.includes.filter')
    <!-- push external js -->
    @push('script')
        @include('panel.admin.include.more-action', [
            'actionUrl' => 'admin/age-groups',
            'routeClass' => 'age-groups',
        ])
        <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        <script>
            $('#reset').click(function() {
                let url = "{{ route('panel.admin.age-groups.index') }}";
                fetchData(url);
