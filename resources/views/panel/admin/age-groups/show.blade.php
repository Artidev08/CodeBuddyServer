...
@section('title', 'Age Group' . ' Show')
@section('content')
    @php
        $breadcrumb_arr = [
            ['name' => 'Age Group', 'url' => route('panel.admin.age-groups.index'), 'class' => ''],
            ['name' => 'Show ' . $ageGroup->getPrefix(), 'url' => 'javascript:void(0);', 'class' => 'Active'],
        ];
    @endphp
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-6 text-muted">
                            ...
                            <h6 class="text-black">{{ $ageGroup->name }}</h6>
                        ...
                        <div class="col-md-4 col-6 text-muted">
                            ...
                            <h6 class="text-black">{{ $ageGroup->description }}</h6>
