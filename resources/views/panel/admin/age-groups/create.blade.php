...
@section('content')
    @php
        ...
        $breadcrumb_arr = [
            ['name' => 'Age Group', 'url' => route('panel.admin.age-groups.index'), 'class' => ''],
            ['name' => 'Add Age Group', 'url' => 'javascript:void(0);', 'class' => 'active'],
        ];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>@lang('admin/ui.add') Age Group</h5>
                            <span>@lang('admin/ui.add_a_new_record_for') Age Group</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>@lang('admin/ui.create') Age Group</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('panel.admin.age-groups.store') }}" method="post"
                            enctype="multipart/form-data" class="ajaxForm" id="AgeGroupForm">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        <x-label name="name" validation="common_name" tooltip="add_age_group_name"
                                            class="" />
                                        <x-input type="text" validation="" value="{{ old('name') }}" name="name"
                                            id="name" placeholder="Enter Name" class="form-control" regex=''
                                            validation='common_name' tooltip="add_name" />
                                    </div>
                                </div>
                                @php
                             ...
                             <div class="col-md-6 mt-35">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                        <x-label name="description" validation="" tooltip="add_age_group_description"
                                            class="" />
                                        <textarea type="text" validation="" value="{{ old('description') }}" name="description" id="description"
                                            placeholder="Enter Description" class="form-control" tooltip="add_age_group_description"></textarea>
                                    </div>
                                </div>
