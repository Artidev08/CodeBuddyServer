                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_language'))
                                <a href="{{ route('panel.admin.languages.create') }}"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.languages.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.languages.includes.filter')
    <!-- push external js -->
    @push('script')
        ...
        <script>
            $('#reset').click(function() {
                let url = "{{ route('panel.admin.languages.index') }}";
                fetchData(url);
