                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_relation'))
                                <a href="{{ route('panel.admin.relations.create') }}"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.relations.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.relations.includes.filter')
    <!-- push external js -->
    @push('script')
        @include('panel.admin.include.more-action', [
            'actionUrl' => 'admin/relations',
            'routeClass' => 'relations',
        ])
        <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        <script>
            $('#reset').click(function() {
                let url = "{{ route('panel.admin.relations.index') }}";
                fetchData(url);
