    ...
    <div class="modal-dialog modal-dialog-centered modal-center">
        <div class="modal-content" style="width: 170%;">
            <div class="modal-header">
                ...
                <form action="{{ route('panel.admin.users.export') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="d-flex justify-content-between mt-0">
                        <div class="text-right">
                            <button type="submit"
                                href="{{ route('panel.admin.users.export') }}"class="btn btn-link">Download
                                Prefill Excel</button>
                        </div>
                    </div>
                </form>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="previous-month" role="tabpanel"
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('panel.admin.bulk.users') }}" method="POST"
                            enctype="multipart/form-data" onsubmit="return checkCoords();">
                            <input type="hidden" name="role" value="{{ request()->role }}">
                            @csrf
                            <div>
                                <div class="alert alert-warning" style="padding: 0.75rem 1rem;">
                                    <p class="mb-0">For adding new {{ @$label }}, please leave the
                                        'ID' column blank.</p>
                                    <p class="mb-0">For updating an existing {{ @$label }}, please changes in
                                        same column.</p>
                                </div>
                                <div class="alert alert-info" style="padding: 0.75rem 1rem;">
                                    <p class="mb-0">First Name field is required.</p>
                                    <p class="mb-0">Last Name field is required.</p>
                                    <p class="mb-0">Prompt field is required.</p>
                                </div>
                            </div>
                            ...
                            <small class="text-danger text-left fw-700" >Allowed file: .xlsx .xlsx</small>
