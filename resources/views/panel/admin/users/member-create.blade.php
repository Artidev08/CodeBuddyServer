                ...
                <div class="col-lg-4 d-sm-flex d-lg-block">
                    <nav class="breadcrumb-container " aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('panel.admin.users.index') }}">Agent</a>
                            </li>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" id="phone" name="phone"
                                                value="{{ $random }}" style="color:white !important background-color: #3d405d;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <x-date regex="dob" :max="$now" validation="" type="date"
                                            value="{{ $dob }}" name="dob" id="dob"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <x-input name="password"
                                                ...
                                                validation="admin_password" value="Gg446$%^765A" />
                            ...
                            <div class="row">
                                        ...
                                        <select required name="ai_payload[model]" id="model" data-flag="0"
                                            ...
                                            @foreach (getCategoriesByCode('ModelCategories') as $model)
                                                <option value="{{ $model->name }}"
                                                    {{ request('model') == $model->name ? 'Selected' : '' }}>
                                                    {{ $model->name ?? '' }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="12" class="form-control" name="ai_payload[prompt]" required id="ai_payload" placeholder="Enter Prompt">
                                            {{ old('ai_payload[prompt]', "
                                                

Craft an original {ContentCategory} for {Occasion}, incorporating {Event} in a meaningful way. The {ContentCategory} should be written in {Language}, convey a {Sentiment} sentiment, and reflect the {Relation} relationship. Ensure the message is within {ContentLength} characters.

Avoid using emojis. The message should feel fresh and authentic.") }}
                                        </textarea>
                                    </div>
                                </div>
                            </div>
