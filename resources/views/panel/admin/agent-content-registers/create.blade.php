...
@section('content')
    @php
         ...
         */
        $breadcrumb_arr = [['name' => 'Add Register', 'url' => route('panel.admin.agent-content-registers.index'), 'class' => '']];
    @endphp
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-0">
                    ...
                    <form action="{{ route('panel.admin.agent-content-registers.store') }}" method="POST" class="ajaxForm">
                        @csrf
