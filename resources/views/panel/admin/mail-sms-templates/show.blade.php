...
@section('content')
@php
    $breadcrumb_arr = [['name' => __('admin/ui.left_sidebar_mail_sms_templates'), 'url' => route('panel.admin.templates.index'), 'class' => ''], ['name' => $mailSmsTemplate->getPrefix(), 'url' => route('panel.admin.templates.index'), 'class' => ''], ['name' => __('admin/ui.show'), 'url' => route('panel.admin.templates.index'), 'class' => 'active']];
@endphp
