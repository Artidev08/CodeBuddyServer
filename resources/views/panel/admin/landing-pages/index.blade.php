                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_landing_page'))
                                <a href="{{ route('panel.admin.landing-pages.create') }}"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.landing-pages.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.landing-pages.includes.filter')
    <!-- push external js -->
    @push('script')
        ...
        <script>
            $('#reset').click(function() {
                let url = "{{ route('panel.admin.landing-pages.index') }}";
                fetchData(url);
