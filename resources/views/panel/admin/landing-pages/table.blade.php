                    ...
                    @if (!isset($print_mode))
                        <td class="no-export">
                            <div class="dropdown d-flex">
                                ...
                                @if ($permissions->contains('edit_landing_page') || $permissions->contains('delete_landing_page'))
