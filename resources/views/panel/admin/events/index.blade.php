                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_event'))
                                @if ($occasion_id != null)
                                    <a href="{{ route('panel.admin.events.create', ['occasion_id' => encrypt($occasion_id)]) }}"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.events.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.events.includes.filter')
    <!-- push external js -->
    @push('script')
