                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_media_type'))
                                <a href="{{ route('panel.admin.media-types.create') }}"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.media-types.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.media-types.includes.filter')
    <!-- push external js -->
    @push('script')
        @include('panel.admin.include.more-action', [
            'actionUrl' => 'admin/media-types',
            'routeClass' => 'media-types',
        ])
        <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        <script>
            $('#reset').click(function() {
                let url = "{{ route('panel.admin.media-types.index') }}";
                fetchData(url);
