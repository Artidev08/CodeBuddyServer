                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_gender_specificity'))
                                <a href="{{ route('panel.admin.gender-specificities.create') }}"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.gender-specificities.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.gender-specificities.includes.filter')
    <!-- push external js -->
    @push('script')
        @include('panel.admin.include.more-action', [
            'actionUrl' => 'admin/gender-specificities',
            'routeClass' => 'gender-specificities',
        ])
        <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        <script>
            $('#reset').click(function() {
                let url = "{{ route('panel.admin.gender-specificities.index') }}";
                fetchData(url);
