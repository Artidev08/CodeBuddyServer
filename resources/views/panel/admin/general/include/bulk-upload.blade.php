    ...
    <div class="modal-dialog modal-dialog-centered modal-center">
        <div class="modal-content" style="width: 170%;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Create/Update Setting</h5>
                <form action="{{ route('panel.admin.general.export') }}" method="POST" enctype="multipart/form-data"
                    onsubmit="return checkCoords();">
                    @csrf
                    <div class="d-flex justify-content-between mt-0">
                        <div class="text-right">
                            <button type="submit"
                                href="{{ route('panel.admin.general.export') }}"class="btn btn-link">Download
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="previous-month" role="tabpanel"
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('panel.admin.bulk.general-setting') }}" method="POST"
                            enctype="multipart/form-data" onsubmit="return checkCoords();">
                            @csrf
                            <div>
                                <div class="alert alert-warning" style="padding: 0.75rem 1rem;">
                                    <p class="mb-0">For updating an existing Setting, please leave the 'ID' column
                                        blank.</p>
                                </div>
                                <div class="alert alert-info" style="padding: 0.75rem 1rem;">
                                    <p class="mb-0">All field is required.</p>
                                </div>
                            </div>
