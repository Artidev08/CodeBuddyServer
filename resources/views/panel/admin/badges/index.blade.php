                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justicy-content-right">
                            @if ($permissions->contains('add_badge'))
                                <a href="{{ route('panel.admin.badges.create') }}"
                    ...
                    <div id="ajax-container">
                        @include('panel.admin.badges.load')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('panel.admin.badges.includes.filter')
    <!-- push external js -->
    @push('script')
        @include('panel.admin.include.more-action', [
            'actionUrl' => 'admin/badges',
            'routeClass' => 'badges',
        ])
        <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        <script>
            $('#reset').click(function() {
                let url = "{{ route('panel.admin.badges.index') }}";
                fetchData(url);
