...
@section('content')
    @php
        ...
        $breadcrumb_arr = [
            ['name' => 'occasion', 'url' => route('panel.admin.occasions.index'), 'class' => ''],
            ['name' => 'Add occasion', 'url' => 'javascript:void(0);', 'class' => 'active'],
        ];
    @endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>@lang('admin/ui.add') occasion</h5>
                            <span>@lang('admin/ui.add_a_new_record_for') occasion</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>@lang('admin/ui.create') occasion</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('panel.admin.occasions.store') }}" method="post"
                            enctype="multipart/form-data" class="ajaxForm" id="occasionForm">
                            @csrf
                            ...
                            <x-input type="hidden" validation="" value="{{@$contentCategory->id}}" name="content_category_id" id="request_with" />
                            <div class="row">
                                ...
                                <div class="col-md-12 ml-auto">
                                    <div class="form-group">
                                        <button id="submit" type="submit" class="btn btn-primary floating-btn ajax-btn"> @lang('admin/ui.create')
                                        </button>
                                    </div>
                                </div>
                            </div>
