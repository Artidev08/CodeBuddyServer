...
class ChartDetailController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $charts= $charts->latest()->paginate($length);
        if ($request->ajax()) {
            return view('admin.chart-detail.load', ['charts' => $charts])->render();
        }
        return view('admin.chart-detail.index', compact('charts','chart'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.chart-detail.edit', compact('chartDetail'));
        } catch (Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('admin.chart-details.index',['chart_id' => $chartDetail->chart_id,'chunk_id' => $chartDetail->chunk_id])->with('success', 'Chart details updated successfully.');
        } catch (Exception $e) {
            return back()->with('error', 'There was an error: ' . $e->getMessage());
        }
    }
